...
### Organization : [ContattoContare](https://github.com/ContattoContare)
...
| 2 | Άσκηση γραμμής εντολών (arch linux install on VM) | [ΠΑΡΑΔΟΤΕΟ 2](https://github.com/courses-ionio/help/discussions/1254) | Archlinux install σε VMware και μια πρώτη χρήση του λογισμικού με εντολές όπως neofetch,journalctl. |
| 3 | Συμμετοχικό περιεχόμενο A1 | | |
| 4 | Άσκηση γραμμής εντολών (arch linux install on HW) | [ΠΑΡΑΔΟΤΕΟ 4](https://github.com/courses-ionio/help/discussions/1625) | Archlinux install σε HW με i3, εντολή warm-up το Pacvim |
